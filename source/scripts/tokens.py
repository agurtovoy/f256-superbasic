...
class CtrlToken(Token):
    SET_ID = -2
    ID_RANGE = range(0, 8)
    TOKENS = ["#EOL", "#SHIFT1", "#SHIFT2", "#STRING", "#HEXCONST", "#DECIMAL"]
...
# three main token categories are control tokens, punctuation, and keywords
TOKEN_CATEGORIES: list[type[Token]] = [CtrlToken, PunctuationToken, KeywordToken]
